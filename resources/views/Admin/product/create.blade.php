...
@section('title', 'Pizza and Snacks Create Page')
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="card-title">
                            <h3 class="text-center title-2">Pizza, Foods and Drinks</h3>
                        </div>
                        <hr>
                        <form action="{{ route('admin#createProduct') }}" method="post" novalidate="novalidate"
                            ...
                            <div class="form-group">
                                ...
                                <input id="pizzaName" name="pizzaName" value="{{ old('pizzaName') }}"type="text"
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="pizzaDescription" id="pizzaDescription" cols="30" rows="5"></textarea>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="pizzaPrice" class="form-control">
                                @error('pizzaPrice')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
